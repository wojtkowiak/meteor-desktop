...
program
    ...
    .option('-a, --android', 'force add android as a mobile platform instead of ios')
    .option('-i, --init', 'will scaffold .desktop if not present')
...
if (process.argv.length === 2 || !~('-h|--help|run|init|build|build-installer|just-run|package'.indexOf(cmd))) {
