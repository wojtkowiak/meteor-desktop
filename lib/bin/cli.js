 ...
 *
 * @param {string} ddpUrl - the url that Meteor app connects to
 * @returns {string}
 */
...
program
    ...
    .description('creates an installer')
...
if (process.argv.length === 2 || !~('-h|--help|run|init|build|build-installer|just-run|package|update-ddp-url'.indexOf(cmd))) {
