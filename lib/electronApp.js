...
export default class ElectronApp {
    ...
    copyFilesFromDesktop() {
        ...
        // We write the settings.json instead of copying it because getSettings modifies it when
        // building for production.
        fs.writeFileSync(
            this.$.env.paths.electronApp.settings,
            JSON.stringify(this.$.desktop.getSettings(), null, 4)
        );
    }
}
