...
export default class ElectronApp {
    ...
    async build(run = false) {
        ...
        if (!this.$.desktop.check()) {
            this.log.error('seems that you do not have a .desktop dir in your project or it is' +
                ' corrupted. Run \'meteor-desktop init\' to get a new one.');
    ...
    ensureDeps() {
        ...
        // it, as it might be a leftover from an interrupted flow.
        this.handleTemporaryNodeModules();
